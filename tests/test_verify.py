...
class VerifyTest(unittest.TestCase):
    ...
    def test_coupon_without_numeric_price_can_verify(self):
        c={"start":"2026-09-01","end":"2026-09-30","regular_price":None,"promo_price":None,
           "offer_type_hint":"coupon","item_name":"Member coupon","evidence_excerpt":"nationwide coupon evidence"}
        v=verify_offer(c,SOURCE,OBS,NOW)
        self.assertEqual(v["verification_state"],"verified")
